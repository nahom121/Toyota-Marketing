...
const faqs = [
  ...
  },
  {
    ...
    a: "Tickets are generally non-refundable, but if the event is cancelled or rescheduled, you will receive a full refund or the option to transfer your ticket to the new date. Reach out to hello@houstonskateproject.org with any questions.",
  },
  {
    ...
    <section id="faq" className="section-pad bg-cream relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto container-pad">
        ...
        >
          ...
          <a href="mailto:hello@houstonskateproject.org" className="text-crimson hover:underline">
            hello@houstonskateproject.org
          </a>
        </motion.p>
      </div>
    </section>
