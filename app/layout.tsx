...
export const metadata: Metadata = {
  ...
  description:
    "A pop-up roller skating workshop in Houston, TX hosted by national champion skater Michaela. September 27th, 2026. All skill levels welcome. Register now.",
  keywords: [
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: SITE_URL,
    title: "Houston Skate Project · Pop-Up Workshop · September 27, 2026",
    description:
  ...
  twitter: {
    ...
    title: "Houston Skate Project · Pop-Up Workshop · September 27",
    description: "Roll how you want. Express who you are. Houston, TX · September 27, 2026.",
    images: ["/og-image.png"],
  },
