...
export const metadata: Metadata = {
  ...
  description:
    "A pop-up roller skating workshop in Houston, TX — hosted by national champion skater Michaela. July 26th, 2026. All skill levels welcome. Register now.",
  keywords: [
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: SITE_URL,
    title: "Houston Skate Project — Pop-Up Workshop · July 26, 2026",
    description:
  ...
  twitter: {
    ...
    title: "Houston Skate Project — Pop-Up Workshop · July 26",
    description: "Roll how you want. Express who you are. Houston, TX · July 26, 2026.",
    images: ["/poster.png"],
  },
